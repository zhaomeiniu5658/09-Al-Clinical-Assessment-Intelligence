...
class AssessmentTask(Base):
    ...
    doctor_test_path: Mapped[str | None] = mapped_column(String(512), nullable=True)
    doctor_test_original_name: Mapped[str | None] = mapped_column(String(255), nullable=True)
    doctor_test_mime_type: Mapped[str | None] = mapped_column(String(128), nullable=True)
    doctor_test_size: Mapped[int | None] = mapped_column(Integer, nullable=True)
